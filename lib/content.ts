...
export const about = {
  ...
  principles: [
    ...
    },
    {
      ...
      body: "Enterprise data is messy. My job is to give it structure with hierarchy, defaults, and progressive disclosure, so the screen never overwhelms.",
    },
    {
    ...
    },
    {
      ...
      body: "I integrate AI where it removes real friction, such as grammar assistance, drafting, and summarization, inside the flow people already use.",
    },
  ],
  journey: [
    {
...
export const projects: Project[] = [
  {
    ...
    accent: "#8c2f39",
    summary:
      "A predictive-maintenance and vibration-analysis platform for industrial equipment in oil & gas environments. It combines live equipment-health dashboards, an editable reporting module, collaborative review, and an AI grammar assistant into one workflow.",
    ...
    challenges: [
      {
        ...
        body: "Equipment monitoring generates a firehose of metrics. The dashboard had to surface what matters now while keeping detail one click away. We solved this with a hierarchy of summary tiles, trend charts, and drill-downs.",
      },
      {
...
export const explorations: Exploration[] = [
  ...
  },
  {
    ...
    research: "Aligned on tokens like spacing, radius, color, and type before building components.",
    decision:
